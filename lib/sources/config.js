...
zz.ide.config = function( ){
    ...
    zz.app.services.FELayoutRouter.getInstance( )

        //.when( '/models/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/models' );
        //} )
        //.when( '/templates/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/templates' );
        //} )
        //.when( '/styles/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/styles' );
        //} )
        //.when( '/messages/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).zz.ide.controllers.Filelist( '/messages' );
        //} )
        //.when( '/resources/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/resources' );
        //} )
        //.when( '/controllers/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/controllers' );
        //} )
        //.when( '/enums/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/enums' );
        //} )
        //.when( '/errors/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/errors' );
        //} )
        //.when( '/events/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/events' );
        //} )
        //.when( '/factories/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/factories' );
        //} )
        //.when( '/services/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/services' );
        //} )
        //.when( '/views/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/views' );
        //} )
        //.when( '/tests/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/tests' );
        //} )
        //.when( '/index/', undefined, undefined, function( ){
        //
        //    zz.app.services.FELayoutRouter.getInstance( ).setFragment( '/index' );
        //} )
