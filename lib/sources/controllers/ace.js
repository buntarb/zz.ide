    ...
    if( this.getView( ).isActionShowHistory( e ) ){
        ...
        if( zz.ide.services.PopupApi
            ...
            zz.ide.services.PopupApi
                ...
                .getInstance( )
                .getPopupController( ).renderChildController(
 ...
 * @private
 */
zz.ide.controllers.Ace.prototype.enterHandler_ = function( e ){

    if( this.getView( ).getTooltip( e ) ){

        zz.ide.services.TooltipApi

            .getInstance( )
            .openTooltip(

                this.getView( ).getTooltip( e ),
                e.elements[ 0 ]
            );
    }
 ...
 * @private
 */
zz.ide.controllers.Ace.prototype.leaveHandler_ = function( e ){
