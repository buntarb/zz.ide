...
zz.ide.controllers.Ace.prototype.setAceHeaderIcon = function( ){
    ...
    this.getModel( ).lastDatarow( ).headerIcon = zz.ide.services.ConstantsConverter

        .getInstance( )
        .getIconFromRoute( this.getRoute( ) );

    this.getModel( ).lastDatarow( ).headerIconClass = zz.ide.services.ConstantsConverter

        .getInstance( )
        .getClassFromRoute( this.getRoute( ) );
...
zz.ide.controllers.Ace.prototype.routeChangedHandler_ = function( e ){
    ...
    if( this.isCurrRoute( ) ){
        ...
        if( this.getTabController( ) ){

            this.getTabController( ).updateRequest( );
        }
    }
};
/**
...
zz.ide.controllers.Ace.prototype.displayHistory = function( ){
    ...
    this.getModel().lastDatarow().showHistory = this.hashViewApi_.displayHistoryStatus( );
};

/**
 * Get tab controller.
 * @return {zz.ide.controllers.Tab|boolean}
 */
zz.ide.controllers.Ace.prototype.getTabController = function( ){
