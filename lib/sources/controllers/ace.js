...
zz.ide.controllers.Ace.prototype.enterDocument = function( ){
    ...
    this.initializeEditor_( this.getModel( ).lastDatarow( ) );
};
...
zz.ide.controllers.Ace.prototype.initializeEditor_ = function( datarow ){
    ...
    this.getModel( ).lastDatarow( ).height =
        ...
        zz.environment.services.Environment.getInstance( ).viewport.getSize( ).height - zz.ide.enums.Const.CORRECTION_HEIGHT;
