...
zz.ide.controllers.Ace.prototype.setAceHeaderIcon = function( ){
    ...
    this.getModel( ).lastDatarow( ).headerIcon = zz.ide.services.ConvertConstants

        .getInstance( )
        .getIconFromRoute( this.getRoute( ) );

    this.getModel( ).lastDatarow( ).headerIconClass = zz.ide.services.ConvertConstants
...
zz.ide.controllers.Ace.prototype.updateRequest = function( ){
    ...
    if( this.getWSClient( ).isReady( ) ){
        ...
        if( folder === '' ){
            ...
            this.requestPath_ = zz.ide.services.ConvertConstants
            ...
            path = zz.ide.services.ConvertConstants
