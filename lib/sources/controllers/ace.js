...
/**
 * Set icon for ace header
 */
zz.ide.controllers.Ace.prototype.setAceHeaderIcon = function( ){

    if( goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.MODELS, 'g' ), this.getRoute( ) ) ){

        this.getModel( ).lastDatarow( ).headerIcon = zz.ide.enums.Const.ICON_MODELS;
        this.getModel( ).lastDatarow( ).headerIconClass = zz.ide.enums.CssClass.ICON_MODELS;

    }else if( goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.TEMPLATES, 'g' ), this.getRoute( ) ) ){

        this.getModel( ).lastDatarow( ).headerIcon = zz.ide.enums.Const.ICON_TEMPLATES;
        this.getModel( ).lastDatarow( ).headerIconClass = zz.ide.enums.CssClass.ICON_TEMPLATES;

    }else if( goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.STYLES, 'g' ), this.getRoute( ) ) ){

        this.getModel( ).lastDatarow( ).headerIcon = zz.ide.enums.Const.ICON_STYLES;
        this.getModel( ).lastDatarow( ).headerIconClass = zz.ide.enums.CssClass.ICON_STYLES;

    }else if( goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.MESSAGES, 'g' ), this.getRoute( ) ) ){

        this.getModel( ).lastDatarow( ).headerIcon = zz.ide.enums.Const.ICON_MESSAGES;
        this.getModel( ).lastDatarow( ).headerIconClass = '';

    }else if( goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.CONTROLLERS, 'g' ), this.getRoute( ) )

        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.ENUMS, 'g' ), this.getRoute( ) )
        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.ERRORS, 'g' ), this.getRoute( ) )
        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.EVENTS, 'g' ), this.getRoute( ) )
        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.FACTORIES, 'g' ), this.getRoute( ) )
        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.VIEWS, 'g' ), this.getRoute( ) )
        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.TESTS, 'g' ), this.getRoute( ) )
        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.INDEX, 'g' ), this.getRoute( ) ) ){

        this.getModel( ).lastDatarow( ).headerIcon = zz.ide.enums.Const.ICON_FOLDER;
        this.getModel( ).lastDatarow( ).headerIconClass = '';

    }else if( goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.BASE_JS, 'g' ), this.getRoute( ) )

        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.PACKAGE_JSON, 'g' ), this.getRoute( ) )
        || goog.dom.pattern.matchStringOrRegex( new RegExp( zz.ide.enums.Route.CONFIG_YAML, 'g' ), this.getRoute( ) ) ){

        this.getModel( ).lastDatarow( ).headerIcon = zz.ide.enums.Const.ICON_FILE;
        this.getModel( ).lastDatarow( ).headerIconClass = '';
    }
    if( this.getModel( ).lastDatarow( ).headerIconClass ){

        goog.dom.classlist.add( this.getElement( ), this.getModel( ).lastDatarow( ).headerIconClass );
    }
};
