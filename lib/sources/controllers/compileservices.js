...
zz.ide.controllers.CompileServices.prototype.bootstrap = function( ){
    ...
    this.getView( ).addHoverEffect( goog.dom.getElement( zz.ide.enums.CssClass.COMPILE_APP ) );
};
...
zz.ide.controllers.CompileServices.prototype.enterHandler_ = function( e ){
    ...
    goog.dom.classlist.remove( e.model.elements[ 0 ], zz.ide.enums.CssClass.BLUR );
    e.stopPropagation( );
};
...
zz.ide.controllers.CompileServices.prototype.leaveHandler_ = function( e ){
    ...
    goog.dom.classlist.add( e.model.elements[ 0 ], zz.ide.enums.CssClass.BLUR );
    e.stopPropagation( );
};
