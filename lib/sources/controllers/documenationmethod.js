 ...
 */
zz.ide.controllers.DocumentationMethod = function( opt_dom ){

    var view = zz.ide.views.DocumentationMethod.getInstance( );
    var model = this.getParent( ).getModel( ).lastDatarow( ).method;
    goog.base( this, model, view, opt_dom );
};

goog.inherits( zz.ide.controllers.DocumentationMethod, zz.ide.controllers.BaseViewController );
zz.environment.services.MVCTree
    .registry
    .setController( 'documentationMethod', zz.ide.controllers.DocumentationMethod );
