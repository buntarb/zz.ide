 ...
 * @param {zz.ide.views.DocumentationMethod} view
 * @param opt_dom
 * @constructor
...
zz.environment.services.MVCRegistry.setController( 'documentationMethod', zz.ide.controllers.DocumentationMethod );
