...
goog.require( 'zz.ide.views.DocumentationValue' );
 ...
 */
zz.ide.controllers.DocumentationValue = function( model, opt_dom ){

    var view = zz.ide.views.DocumentationValue.getInstance( );
    var model = this.getParent( ).getModel( ).lastDatarow( ).value;
