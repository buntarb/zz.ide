...
zz.ide.controllers.Filelist.prototype.removeFileHandler_ = function( e ){
    ...
    if( removeFileMessageModel.firstDatarow( ).stdout.length ){
        ...
        zz.environment.services.Environment
            ...
            .getRootController( )
            .getLayoutController( )
            .openError( true, false, 100, 200, removeFileMessageModel.firstDatarow( ).stdout  );

    }else if( removeFileMessageModel.firstDatarow( ).stderr.length ){
