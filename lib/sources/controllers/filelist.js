...
zz.ide.controllers.Filelist.prototype.setupModelInternal = function( ){
    ...
    if( this.getWSClient( ).isReady( ) ){
        ...
        var path = zz.ide.services.RouteToPath.getInstance().getPath( this.getRouter( ).getFragment( ) );
...
zz.ide.controllers.Filelist.prototype.getChildrenHandler_ = function( e ){
    ...
    if( getChildrenMessageModel.firstDatarow( ).stderr.length ){
        ...
        zz.environment.services.Environment
            ...
            .getRootController( )
            .getLayoutController( )
            .openError( true, false, 100, 200, getChildrenMessageModel.firstDatarow( ).stderr );
...
zz.ide.controllers.Filelist.prototype.removeFileHandler_ = function( e ){
   ...
   if( removeFileMessageModel.firstDatarow( ).stderr.length ){
        ...
        zz.environment.services.Environment
            ...
            .getRootController( )
            .getLayoutController( )
            .openError( true, false, 100, 200, removeFileMessageModel.firstDatarow( ).stderr  );
    ...
    if( !zz.environment.services.Environment
        ...
        zz.environment.services.Environment
            ...
            .openModal(
                ...
                215,
                380,
                goog.style.getSize( this.getLayout( ).getElement( ) ).height/2 - 107,
                goog.style.getSize( this.getLayout( ).getElement( ) ).width/2 - 190
            );
    ...
    if( !zz.environment.services.Environment
        ...
        zz.environment.services.Environment
            ...
            .openModal(
                ...
                225,
                380,
                goog.style.getSize( this.getLayout( ).getElement( ) ).height/2 - 112,
                goog.style.getSize( this.getLayout( ).getElement( ) ).width/2 - 190
            );
