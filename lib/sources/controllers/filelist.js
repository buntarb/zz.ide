...
zz.ide.controllers.Filelist = function( model, view, opt_dom ){
  ...
  this.getHandler( ).listen(
    ...
    this.getHandler( ).listen(
        ...
        zz.ide.enums.EventType.WEB_SOCKET_MESSAGE_RECEIVE,
        this.wsmessageHandler_,
        false
    );
};
...
zz.ide.controllers.Filelist.prototype.wsmessageHandler_ = function( e ){
    ...
    var dataset = new zz.net.models.MessageDataset( null, e.input.messageData );
    ...
    if( datarow.type === zz.net.enums.MessageType.ERROR ){
        ...
        if( e.input.messageSource === zz.ide.enums.Command.GET_CHILDREN ){
        ...
        }else if( e.input.messageSource === zz.ide.enums.Command.OPEN_FILE ){

            console.log( 'RESPONSE OPEN_FILE' );

        }else if( e.input.messageSource === zz.ide.enums.Command.SAVE_FILE ){
