...
zz.ide.controllers.Filelist.prototype.wsmessageHandler_ = function( e ){
    ...
    if( datarow.type === zz.net.enums.MessageType.ERROR ){
        ...
        if( e.input.type === zz.ide.enums.Command.GET_CHILDREN ){
        ...
        }else if( e.input.type === zz.ide.enums.Command.OPEN_FILE ){

            console.log( 'RESPONSE OPEN_FILE' );

        }else if( e.input.type === zz.ide.enums.Command.SAVE_FILE ){
