...
zz.ide.controllers.Filelist.prototype.actionHandler_ = function( e ){
    ...
    if( e.elements[ 0 ].getAttribute( zz.ide.enums.DataAction.OPEN ) ){
        ...
        zz.environment.services.Environment.getInstance( )
            ...
            .getRootController( ).getModel( ).lastDatarow( ).modal.createLast( [true, false, 200, 100] );


        //var layoutModel = zz.environment.services.Environment.getInstance( )
        //
        //    .getRootController( ).getModel( ).lastDatarow( ).layout.lastDatarow( );
        //
        //layoutModel.modalDeleteIsShown = true;
        //
        //var model = this.getModel( ).lastDatarow( );
        //var loop = true;
        //
        ...
        //    while( loop ){
        //
        //        if( model.currentDatarow( ).getUid(  ) === this.getModel( ).lastDatarow( ).deleteFileDatarowUID ){
        //
        //            zz.ide.services.ClientApi.getInstance( ).removeFile( model.currentDatarow( ) );
        //            model.deleteCurrent( );
        //            loop = false;
        //        }else{
        //
        ...
        //    }
        //}
        //layoutModel.deleteFileDatarow = e.model.getUid( );
    }
