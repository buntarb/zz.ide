...
/**
 * Change route event handler.
 * @private
 */
zz.ide.controllers.Filelist.prototype.routeChagedHandler_ = function( e ){

    if( goog.array.indexOf( e.curr_, '/?file=' ) < 0  ) {
