...
zz.environment.services.MVCTree
    .registry
    .setController( 'header', zz.ide.controllers.Header );
...
zz.ide.controllers.Header.prototype.setupListenersInternal = function( ){
    ...
    this.getHandler( ).listenWithScope(
        ...
        this.wsc_,
        zz.ide.enums.Command.JSDOC_COMPLETE,
    ...
    this.getHandler( ).listenWithScope(
        ...
        this.fullSearchResponseHandler_,
        false,
        this
    );
};
...
zz.ide.controllers.Header.prototype.actionHandler_ = function( e ){
    ...
    if( this.getView( ).isActionShowNavigation( e ) ){
    ...
    }else if( this.getView( ).isActionServicesBtn( e ) ){
        ...
        if( this.layout_.getModel( ).lastDatarow( ).popup.length &&
            ...
            this.layout_.openPopup(
                ...
                goog.dom.getViewportSize( ).width - 340 );

            var servicesModel = new zz.ide.models.Services( );
            var servicesController =
                new zz.ide.controllers.Services( servicesModel );
...
zz.ide.controllers.Header.prototype.searchQueryHandler_ = function( e ){
    ...
    if( e.message.datafield === this.getModel( ).datafield.search ){
        ...
        if( this.layout_.getPopupController( ).getChildCount( ) === 1 ){
            
            var listModel = this.layout_
        ...
        if( e.message.new_value !== '' ){
            ...
            zz.ide.services.SearchApi
                ...
                .getInstance( )
                .sendQueryAutocomplite( e.message.new_value );
        }
    }
    e.stopPropagation( );
};
 ...
 * @private
 */
zz.ide.controllers.Header.prototype.searchResponseHandler_ = function( e ){
 ...
 * @private
 */
zz.ide.controllers.Header.prototype.fullSearchResponseHandler_ = function( e ){
    ...
    this.layout_.closeModal( );
    if( documentationData.length ){

        this.layout_.openModal(
        ...
        var documentationModel = zz.ide.services.DocApi
            ...
            .getInstance( )
            .getDocumentationModel( documentationData[ 0 ] );
        ...
        var documentationController =
            new zz.ide.controllers.Documentation( documentationModel );
            
        this.layout_.getModalController( ).renderChildController(
