...
zz.ide.controllers.Header.prototype.actionHandler_ = function( e ){
    ...
    if( this.getView( ).isActionShowNavigation( e ) ){
        ...
        if( this.layout_.getModel( ).lastDatarow( ).popup.length
            ...
            this.layout_.openPopup( 'services', undefined, 200, 200, 56, 150 );
            var servicesModel = new zz.ide.models.Services( );
            var servicesController = new zz.ide.controllers.Services( servicesModel );
            servicesController.render( goog.dom.getElement( zz.ide.enums.CssClass.POPUP ) );
        }
    }
...
zz.ide.controllers.Header.prototype.searchHandler_ = function( e ){
    ...
    if( e.message.datafield === this.getModel( ).datafield.search ){
        ...
        console.log( 'old', e.message.old_value, 'new', value );
        ...
        if( value !== '' ){
            ...
            if( popupSearchlistModel.length ){
                ...
                this.layout_.openPopup( 'search', undefined, 200, 200, 56, 150 );
