...
zz.ide.controllers.Layout.prototype.actionHandler_ = function( e ){
    ...
    if( e.elements[ 0 ].getAttribute( zz.ide.enums.DataAction.ADD_BTN ) ){
        ...
        this.getModel( ).lastDatarow( ).compilingApp = true;
    }
};
...
zz.ide.controllers.Layout.prototype.compileHandler_ = function( e ){
    ...
    switch( e.type ){
        ...
        case zz.ide.enums.Command.COMPILE_APP:
            ...
            this.getModel( ).lastDatarow( ).compilingApp = false;
            break;
 ...
 */
zz.ide.controllers.Layout.prototype.routeChangedHandler_ = function( e ){

    if( goog.dom.pattern.matchStringOrRegex( /file=/g, this.router_.getFragment( ) ) ){

        this.getModel( ).addBtnShow = false;

    }else{

        this.getModel( ).addBtnShow = true;
    }
};
