...
goog.require( 'zz.ide.services.ConvertConstants' );
...
zz.ide.controllers.Layout.prototype.setViewInternal = function( viewCtrl ){
    ...
    if( this.hashView_[ this.router_.getFragment( ) ] ){

        goog.dom.appendChild( this.getViewWrapper( ), this.hashView_[ this.router_.getFragment( ) ].getElement( ) );
        this.hashView_[ this.router_.getFragment( ) ].updateRequest( );
        this.viewCtrl_ = this.hashView_[ this.router_.getFragment( ) ];
    }else{

        this.viewCtrl_ = new viewCtrl( );
        this.addChild( this.viewCtrl_, false );
        this.viewCtrl_.render( this.getViewWrapper( ) );
        this.hashView_[ this.router_.getFragment( ) ] = this.getViewController( );
    }
};
...
zz.ide.controllers.Layout.prototype.actionHandler_ = function( e ){
    ...
    if( this.getView( ).isActionAddBtn( e ) ){
       ...
       this.openModalAddFile( );
        ...
        if( goog.dom.pattern.matchStringOrRegex( /file=/g, this.router_.getFragment( ) ) ){
            ...
            this.startCompilingId_ = zz.ide.enums.Command.COMPILE_APP;
            this.viewCtrl_.saveFile( );
        ...
        if( goog.dom.pattern.matchStringOrRegex( /file=/g, this.router_.getFragment( ) ) ){
            ...
            this.startCompilingId_ = zz.ide.enums.Command.COMPILE_SOY;
            this.viewCtrl_.saveFile( );
        ...
        if( goog.dom.pattern.matchStringOrRegex( /file=/g, this.router_.getFragment( ) ) ){
            ...
            this.startCompilingId_ = zz.ide.enums.Command.COMPILE_CSS;
            this.viewCtrl_.saveFile( );

        }else{

            this.startCompiling( zz.ide.enums.Command.COMPILE_CSS );
        }
        ...
        if( goog.dom.pattern.matchStringOrRegex( /file=/g, this.router_.getFragment( ) ) ){
            ...
            this.startCompilingId_ = zz.ide.enums.Command.COMPILE_MODELS;
            this.viewCtrl_.saveFile( );
        ...
        if( goog.dom.pattern.matchStringOrRegex( /file=/g, this.router_.getFragment( ) ) ){
            ...
            this.startCompilingId_ = zz.ide.enums.Command.CALCDEPS;
            this.viewCtrl_.saveFile( );
    ...
    }else if( this.getView( ).isActionExtractingMsg( e ) ){

        if( goog.dom.pattern.matchStringOrRegex( /file=/g, this.router_.getFragment( ) ) ){

            this.startCompilingId_ = zz.ide.enums.Command.EXTRACTMSG;
            this.viewCtrl_.saveFile( );

        }else{

            this.startCompiling( zz.ide.enums.Command.EXTRACTMSG );
        }
 ...
 * @private
 */
zz.ide.controllers.Layout.prototype.saveFileHandler_ = function( e ){
        ...
        this.getModalController( )
            ...
            .renderChildController(
                ...
                new zz.ide.controllers.ModalAddFile(
                    ...
                    zz.ide.services.ConvertConstants
...
zz.ide.controllers.Layout.prototype.startCompiling = function( command ){
    ...
    switch( command ){
        ...
        case zz.ide.enums.Command.EXTRACTMSG:
            ...
            this.getModel( ).lastDatarow( ).compiling = true;
            this.getModel( ).lastDatarow( ).extractingMsg = true;
            break;
    }
};
...
zz.ide.controllers.Layout.prototype.finishCompiling = function( command ){
    ...
    switch( command ){
        ...
        case zz.ide.enums.Command.EXTRACTMSG:
            ...
            this.getModel( ).lastDatarow( ).compiling = false;
            this.getModel( ).lastDatarow( ).extractingMsg = false;
            break;
    }
};
 ...
 *  @param {string} route
 */
zz.ide.controllers.Layout.prototype.removeFromHashView = function( route ){

    if(  this.hashView_[ route ].isCurrRoute( ) ){

        this.router_.setFragment( this.hashView_[ this.hashView_.length - 1 ] );
        this.closePopup( );
    }
    this.hashView_[ route ].disposeInternal( );
    goog.object.remove( this.hashView_, route );
};