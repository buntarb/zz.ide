...
zz.ide.controllers.Layout.prototype.setViewInternal = function( viewCtrl ){
    ...
    if( this.getCtrlFromHashView( this.router_.getFragment( ) ) ){

        goog.dom.appendChild(

            this.getViewWrapper( ),
            this.getCtrlFromHashView( this.router_.getFragment( ) ).getElement( )
        );
        this.getCtrlFromHashView( this.router_.getFragment( ) ).updateRequest( );
        this.viewCtrl_ =  this.getCtrlFromHashView( this.router_.getFragment( ) );
 ...
 *  @param {string} route
 */
zz.ide.controllers.Layout.prototype.removeCtrlFromHashView = function( route ){
 ...
 *
 */
zz.ide.controllers.Layout.prototype.getCtrlFromHashView = function( route ){

    var controller;
    goog.array.forEach( this.hashView_, function( item ){
 ...
 *  @param {string} route
 */
zz.ide.controllers.Layout.prototype.removeElementFromHashView = function( route ){
    ...
    goog.array.forEach( this.hashView_, function( item ){
        ...
        if( item.route === route ){
            ...
            goog.array.splice( this.hashView_, i, 1 );
        }
        i++;
    });
};