 ...
 *  @override
 */
zz.ide.controllers.Modal.prototype.setupModelInternal = function( ){
...
zz.ide.controllers.Modal.prototype.resizeHandler_ = function( e ){
    ...
    if( this.getModel( ).lastDatarow( ).id === 'documentation' ){
        ...
        this.getModel( ).lastDatarow( ).width = goog.style.getSize( viewWrapperElement ).width - 40;
        this.getModel( ).lastDatarow( ).height = goog.dom.getViewportSize( ).height - 110;
        this.getModel( ).lastDatarow( ).top = 90;
        this.getModel( ).lastDatarow( ).left = goog.style.getPosition( viewWrapperElement).x + 20;

    }else if( this.getModel( ).lastDatarow( ).id === 'error' ){
