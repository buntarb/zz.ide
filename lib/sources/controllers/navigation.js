...
zz.ide.controllers.Navigation.prototype.routeChangedHandler_ = function( opt_e ){
    ...
    if( goog.dom.pattern.matchStringOrRegex( /\/models/, route ) ){
        ...
        this.findSelectedFolder_( zz.ide.enums.FolderTitles.MODELS );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/templates/, route ) ) {

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.TEMPLATES );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/styles/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.STYLES );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/messages/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.MESSAGES );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/resources/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.RESOURCES );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/controllers/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.CONTROLLERS );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/enums/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.ENUMS );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/errors/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.ERRORS );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/events/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.EVENTS );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/factories/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.FACTORIES );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/services/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.SERVICES );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/tests/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.TESTS );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/views/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.VIEWS );

    }else if( goog.dom.pattern.matchStringOrRegex( /\/index/, route ) ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.INDEX );

    }else if( route === zz.ide.enums.Route.BASE_JS ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.BASE_JS );

    }else if( route === zz.ide.enums.Route.CONFIG_YAML ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.CONFIG_YAML );

    }else if( route === zz.ide.enums.Route.PACKAGE_JSON ){

        this.findSelectedFolder_( zz.ide.enums.FolderTitles.PACKAGE_JSON );
 ...
 * @private
 */
zz.ide.controllers.Navigation.prototype.findSelectedFolder_ = function( folderTitle ){
