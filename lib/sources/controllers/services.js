...
zz.ide.controllers.Services.prototype.setupModelInternal = function( ){
    ...
    this.getModel( ).createLast( [ 'Start SRV', 'play_arrow', zz.ide.enums.DataAction.START_SRV ] );
    this.getModel( ).createLast( [ 'Run DEV', 'code', zz.ide.enums.DataAction.RUN_DEV ] );
    this.getModel( ).createLast( [ 'Run DBG', 'bug_report', zz.ide.enums.DataAction.RUN_DBG ] );
    this.getModel( ).createLast( [ 'Run APP', 'build', zz.ide.enums.DataAction.RUN_APP ] );
    this.getModel( ).createLast( [ 'Run UT', 'done_all', zz.ide.enums.DataAction.RUN_UT ] );
...
zz.ide.controllers.Services.prototype.actionHandler_ = function( e ){
    ...
    if( this.getView( ).isActionStartSrv( e ) ){
        ...
        }else if( this.getModel( ).firstDatarow( ).icon === 'pause' ){
...
zz.ide.controllers.Services.prototype.startSrvMessageHandler_ = function( e ){
    ...
    if( messageModel.firstDatarow( ).stdout.length ){
    ...
    if( messageModel.firstDatarow( ).stderr.length ){
        ...
        this.getModel( ).firstDatarow( ).icon = 'pause'
    }
