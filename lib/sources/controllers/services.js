...
zz.ide.controllers.Services.prototype.setupModelInternal = function( ){
    ...
    this.getModel( ).createLast( [ 'Start SRV', 'play_arrow', zz.ide.enums.DataAction.START_SRV, zz.ide.enums.CssClass.START_SERVER ] );
    this.getModel( ).createLast( [ 'Run DEV', 'code', zz.ide.enums.DataAction.RUN_DEV, zz.ide.enums.CssClass.RUN_DEV ] );
    this.getModel( ).createLast( [ 'Run DBG', 'bug_report', zz.ide.enums.DataAction.RUN_DBG, zz.ide.enums.CssClass.RUN_DBG ] );
    this.getModel( ).createLast( [ 'Run APP', 'build', zz.ide.enums.DataAction.RUN_APP, zz.ide.enums.CssClass.RUN_APP ] );
    this.getModel( ).createLast( [ 'Run UT', 'done_all', zz.ide.enums.DataAction.RUN_UT, zz.ide.enums.CssClass.RUN_UT ] );
