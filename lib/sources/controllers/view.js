 ...
 * @param {zz.ide.views.View} view
 * @param opt_dom
 * @constructor
 * @extends {zz.controllers.FEBase}
 */
zz.ide.controllers.View = function( model, view, opt_dom ){

    goog.base( this, model, view, opt_dom );
};

goog.inherits( zz.ide.controllers.View, zz.controllers.FEBase );
zz.environment.services.MVCTree.registry.setController( 'view', zz.ide.controllers.View );
...
zz.ide.controllers.View.prototype.enterDocument = function( ){
    ...
    //this.initializeBlankfolder_( this.getModel( ) );
};
 ...
 * @private
 */
zz.ide.controllers.View.prototype.initializeBlankfolder_ = function( model ){

    var BlankfolderModel = model.currentDatarow( ).Blankfolder;
