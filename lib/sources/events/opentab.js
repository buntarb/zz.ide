...
goog.provide( 'zz.ide.events.OpenTab' );
goog.require( 'zz.events.BaseEvent' );
goog.require( 'zz.ide.enums.EventType' );

/**
 * Tabs controller open tab event class.
 * @param {Object} node
 * @extends {zz.events.BaseEvent}
 * @constructor
 */
zz.ide.events.OpenTab = function( node ){

	goog.base( this, zz.ide.enums.EventType.OPEN_TAB);
...
goog.inherits( zz.ide.events.OpenTab, zz.events.BaseEvent );