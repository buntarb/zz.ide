 ...
 * @param {zz.ide.models.Filelist} datarow
 */
zz.ide.services.ClientApi.prototype.deleteFile = function( datarow ){
 ...
 * @param {zz.ide.models.Filelist} datarow
 */
zz.ide.services.ClientApi.prototype.addFile = function( datarow ){
    ...
    //    datarow.content
    //] );
    //this.wsc_.sendCommandMessage( zz.ide.enums.Command.ADD_FILE, model );
};
