...
zz.ide.services.ClientApi = function( ){
    ...
    goog.base( this, 'zz.ide.services.ClientApi' );
 ...
 * Extract messages.
 */
zz.ide.services.ClientApi.prototype.extractMsg = function( ){

    var model = new zz.ide.models.FilesTree();
    model.createLast( );
    this.wsc_.sendCommandMessage( zz.ide.enums.Command.EXTRACTMSG, model );
};
 ...
 * Start server.
 */
zz.ide.services.ClientApi.prototype.startSrv = function( ){

    var model = new zz.ide.models.WebServerRunner();
    model.createLast( );
    this.wsc_.sendCommandMessage( zz.ide.enums.Command.START_SERVER, model );
};

/**
 * Stop server.
 */
zz.ide.services.ClientApi.prototype.stopSrv = function( ){

    var model = new zz.ide.models.WebServerRunner();
    model.createLast( );
    this.wsc_.sendCommandMessage( zz.ide.enums.Command.STOP_SERVER, model );
};
 ...
 * Check server status.
 */
zz.ide.services.ClientApi.prototype.checkSrvStatus = function( ){

    var model = new zz.ide.models.WebServerRunner( );
    model.createLast( );
    this.wsc_.sendCommandMessage( zz.ide.enums.Command.IS_SERVER_RUNNING, model );
};
