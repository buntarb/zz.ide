...
goog.require( 'zz.ide.events.WebSocketMessageReceive' );
 ...
 * @private
 */
zz.ide.services.ClientApi.prototype.getChildrenHandler_ = function( e ){

    console.log( 'clientapi get children', e );
    //zz.ide.services.ClientApi.getInstance( ).dispatchEvent( new zz.ide.events.WebSocketMessageReceive( e ) );
    e.stopPropagation( );
};
