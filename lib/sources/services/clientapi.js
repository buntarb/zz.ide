 ...
 * @param {string} type
 */
zz.ide.services.ClientApi.prototype.deleteFile = function( name, path, content, type ){
 ...
 * @param {string} type
 */
zz.ide.services.ClientApi.prototype.addFile = function( name, path, content, type ){
