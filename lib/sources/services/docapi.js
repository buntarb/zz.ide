...
zz.ide.services.DocApi.prototype.getDocumentationModel = function( data ){
    ...
    var modelMethod = this.getDocumentationModelMethod( data );
    var modelValue = this.getDocumentationModelValue( data );
 ...
 * @return {zz.ide.models.Documentation|boolean}
 * */
zz.ide.services.DocApi.prototype.getDocumentationModelMethod = function( data ){

    var isMethod = false;
    var model = new zz.ide.models.DocumentationMethod( );
    ...
    return isMethod ? model : isMethod;
};
 ...
 * @return {zz.ide.models.Documentation|boolean}
 * */
zz.ide.services.DocApi.prototype.getDocumentationModelValue = function( data ){

    var isValue = false;
    var model = new zz.ide.models.DocumentationValue( );
