...
<<<<<<< HEAD
            ...
            this.getDocumentationModelProperty( classModel.lastDatarow( ).property, data );
=======
            this.getDocumentationModelMethod(
                classModel.lastDatarow( ).method,
                data );
                
            this.getDocumentationModelValue(
                classModel.lastDatarow( ).value,
                data );
>>>>>>> 4583ab9a27137f1e0a80a1baee1b6b760696230d
        }
    }, this );
