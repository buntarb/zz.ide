    ...
    goog.array.forEach( data, function( dataItem ){
        ...
        if( dataItem[ 'longname' ] === search && dataItem[ 'kind' ] === 'class' ){
            ...
            classModel.createLast( [
                ...
                dataItem[ 'longname' ],
                dataItem[ 'kind' ],
                dataItem[ 'description' ] ? dataItem[ 'description' ] : 'There is not any description for this class.',
                dataItem[ 'meta' ][ 'path' ] + delimiter + dataItem[ 'meta' ][ 'filename' ],
                dataItem[ 'augments' ] ? dataItem[ 'augments' ][ 0 ] : "This class don't have parents."
            ] );
    ...
    goog.array.forEach( data, function( dataItem ){
        ...
        if( dataItem[ 'memberof' ] === search && dataItem[ 'kind' ] === 'function' ){
            ...
            model.createLast( [
                ...
                dataItem[ 'inherited' ] ? dataItem[ 'inherits' ].slice( 0, dataItem[ 'inherits' ].indexOf( '#' ) )
                : dataItem[ 'memberof' ],
                undefined,
                false
            ] );
    ...
    goog.array.forEach( data, function( dataItem ){
        ...
        if( dataItem[ 'memberof' ] === search && dataItem[ 'kind' ] === 'member' ){
            ...
            model.createLast( [
                ...
                dataItem[ 'name' ],
                dataItem[ 'description' ] ? dataItem[ 'description' ] : 'There is not any description for this property.'
            ] );
