...
zz.ide.services.JSDocService = function( url, opt_protocol ){
    ...
    commandListenerMap[ zz.ide.enums.Command.JSDOC_DEFINITIONS ] = { binder: this.defaultBinder_, fun: this.query_ };
    commandListenerMap[ zz.ide.enums.Command.JSDOC_KEYWORDS ]    = { binder: this.defaultBinder_, fun: this.complete_ };
