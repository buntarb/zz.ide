...
zz.ide.services.TernApi = function( ){
    ...
    goog.base( this, 'zz.ide.services.TernApi' );
...
/**
 * Send TERN query for definition.
 * @param {string} file
 * @param {number} line
 * @param {number} column
 * @param {string} content
 */
zz.ide.services.TernApi.prototype.sendDefinitionRequest = function( file, line, column, content ){
...
/**
 * Send TERN query for documentation.
 * @param {string} file
 * @param {number} line
 * @param {number} column
 * @param {string} content
 */
zz.ide.services.TernApi.prototype.sendDocumentationRequest = function( file, line, column, content ){
...
/**
 * Send TERN query for Refs.
 * @param {string} file
 * @param {number} line
 * @param {number} column
 * @param {string} content
 */
zz.ide.services.TernApi.prototype.sendRefsRequest = function( file, line, column, content ){
...
/**
 * Send TERN query for Rename.
 * @param {string} file
 * @param {number} line
 * @param {number} column
 * @param {string} content
 */
zz.ide.services.TernApi.prototype.sendRenameRequest = function( file, line, column, content, newName ){
