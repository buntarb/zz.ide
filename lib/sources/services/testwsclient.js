...
zz.ide.services.TestWSClient = function( url ){
    ...
    this.eventHandler_.listenWithScope(
        this.wsc_,
        zz.ide.enums.Command.TERN_COMPLETIONS,
        this.completionsHandler_,
        false,
        this
    );
    this.eventHandler_.listenWithScope(
    ...
    this.eventHandler_.listenWithScope(
        this.wsc_,
        [ zz.ide.enums.Command.JSDOC_QUERY, zz.ide.enums.Command.JSDOC_COMPLETE ],
        this.jsdocHandler_,
        false,
        this
    );
...
zz.ide.services.TestWSClient.prototype.jsdocHandler_ = function( input ){
    ...
    if( datarow.type === zz.net.enums.MessageType.ERROR ){
        ...
        if( datarow.command === zz.ide.enums.Command.JSDOC_QUERY ){

            console.log( '========================RESPONSE JSDOC_QUERY========================' );
        ...
        }else if( datarow.command === zz.ide.enums.Command.JSDOC_COMPLETE ){

            console.log( '========================RESPONSE JSDOC_COMPLETE========================' );
...
zz.ide.services.TestWSClient.prototype.readyHandler_ = function( ){
    ...
    client.wsc_.sendCommandMessage( zz.ide.enums.Command.JSDOC_QUERY, jsdocModel );

    jsdocModel.deleteLast();
    // jsdocModel.createLast( [ 'create' ] );
    jsdocModel.createLast( [ '/' ] );
    // client.wsc_.sendCommandMessage( zz.ide.enums.Command.JSDOC_COMPLETE, jsdocModel );
