...
zz.ide.services.TestWSClient = function( url ){
    ...
    this.eventHandler_.listenWithScope(
        this.wsc_,
        [ zz.ide.enums.Command.START_SERVER, zz.ide.enums.Command.STOP_SERVER, zz.ide.enums.Command.IS_SERVER_RUNNING ],
...
zz.ide.services.TestWSClient.prototype.webServerRunnerHandler_ = function( input ){
    ...
    if( datarow.type === zz.net.enums.MessageType.ERROR ){
        ...
        if( datarow.command === zz.ide.enums.Command.START_SERVER ){
            ...
            console.log( 'modelDatarow.isrunning = ' +  modelDatarow.isrunning );
        ...
        }else if( datarow.command === zz.ide.enums.Command.IS_SERVER_RUNNING ){

            console.log( '========================RESPONSE IS_SERVER_RUNNING========================' );
...
zz.ide.services.TestWSClient.prototype.readyHandler_ = function( ){
    ...
    setTimeout(function (){
        ...
        client.wsc_.sendCommandMessage( zz.ide.enums.Command.IS_SERVER_RUNNING, model );
