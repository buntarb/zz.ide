 ...
 * @private
 */
zz.ide.views.Ace.prototype.isActionUndo = function( e ){

    return e.elements[ 0 ].getAttribute( zz.ide.enums.DataAction.UNDO ) > 0;
};
 ...
 * @private
 */
zz.ide.views.Ace.prototype.isActionRedo = function( e ){

    return e.elements[ 0 ].getAttribute( zz.ide.enums.DataAction.REDO ) > 0;
};
 ...
 * @private
 */
zz.ide.views.Ace.prototype.getTooltip = function( e ){
