...
zz.ide.views.Filelist = function( ){
    ...
    goog.base( this, zz.ide.templates.filelistDataset, zz.ide.templates.filelistDatarow );
};
goog.inherits( zz.ide.views.Filelist, zz.views.FEBase );
goog.addSingletonGetter( zz.ide.views.Filelist );
zz.environment.services.MVCTree.registry.setView( 'filelist', zz.ide.views.Filelist );