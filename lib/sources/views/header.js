...
zz.environment.services.MVCRegistry.setView( 'header', zz.ide.views.Header );
 ...
 * @private
 */
zz.ide.views.Header.prototype.isActionServicesButton = function( e ){
 ...
 * @param {string} route
 */
zz.ide.views.Header.prototype.setHeaderMenuIcon_ = function( route ){
