...
goog.provide( 'zz.ide.views.HeaderServices' );
...
zz.ide.views.HeaderServices = class extends zz.ui.views.List {
    ...
    constructor(opt_model, opt_dataset, opt_datarow) {
        ...
        super(
            ...
            opt_model ||
                zz.ide.templates.services.caption,
            opt_dataset ||
...
zz.environment.services.MVCRegistry.setView( 'headerServices', zz.ide.views.HeaderServices );
goog.addSingletonGetter( zz.ide.views.HeaderServices );