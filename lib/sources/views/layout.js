...
zz.ide.views.Layout.prototype.popupIsOpen = function( ctrl ){
    ...
    var element = goog.dom.getParentElement( this.popupWrapperElement_ );
    goog.dom.classlist.add( element, zz.ide.enums.CssClass.POPUP_IS_OPEN );
};
...
zz.ide.views.Layout.prototype.popupIsClose = function( ctrl ){
    ...
    var element = goog.dom.getParentElement( this.popupWrapperElement_ );
    goog.dom.classlist.remove( element, zz.ide.enums.CssClass.POPUP_IS_OPEN );
};