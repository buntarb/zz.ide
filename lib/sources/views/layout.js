 ...
 * @private
 */
zz.ide.views.Layout.prototype.isActionExtractingMsg = function( e ){

    return e.elements[ 0 ].getAttribute( zz.ide.enums.DataAction.EXTRACTING_MSG ) > 0;
};
 ...
 * @private
 */
zz.ide.views.Layout.prototype.isActionLayout = function( e ){

    return e.elements[ 0 ].getAttribute( zz.ide.enums.DataAction.LAYOUT ) > 0;
};
