...
goog.require( 'zz.ide.templates.navigation' );
...
zz.ide.views.Navigation = function( ){
    ...
    goog.base( this, zz.ide.templates.navigation.default );
};
goog.inherits( zz.ide.views.Navigation, zz.views.FEBase );
goog.addSingletonGetter( zz.ide.views.Navigation );
zz.environment.services.MVCTree.registry.setView( 'navigation', zz.ide.views.Navigation );
