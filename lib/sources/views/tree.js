...
goog.provide( 'zz.ide.views.Tree' );
 ...
 * @constructor
 */
zz.ide.views.Tree = function( ){

    goog.base( this, zz.ide.templates.treeDataset, zz.ide.templates.treeDatarow );
};
goog.inherits( zz.ide.views.Tree, zz.views.FEBase );
goog.addSingletonGetter( zz.ide.views.Tree );
 ...
 * @private
 */
zz.ide.views.Tree.prototype.datarowUpdatedHandler = function( e ){
    ...
    if( e.message.datafield === e.message.dataset.datafield.isFolderOpen ){
    ...
    }else if ( e.message.datafield === e.message.dataset.datafield.isContextShow ){
        ...
        goog.dom.classlist.add( element, zz.ide.enums.CssClass.CONTEXT_SHOW );
    }
    e.stopPropagation( );
};